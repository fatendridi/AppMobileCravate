...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.navigation_usb:
                        Intent a = new Intent(MainActivity.this,Panier.class);
                        startActivity(a);
                        break;
                    case R.id.navigation_logo:
                        Intent b = new Intent(MainActivity.this,Compte.class);
                        startActivity(b);
                        break;
                    case R.id.navigation_notification:
                        Intent c = new Intent(MainActivity.this,Compte.class);
                        startActivity(c);
                        break;
                ...
                .addOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
                    ...
                    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                        ...
                        if (id == 0) {
                            ...
                            Intent it = new Intent(MainActivity.this,Chemise.class);
                            startActivity(it);
                                ...
                                Intent i1 = new Intent(MainActivity.this,NoeudPapillon.class);
                                startActivity(i1);
                ...
                .addOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                    ...
                    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                        ...
                        if(groupPosition==0) {
                            ...
                            if (id == 0) {
                                Intent i = new Intent(MainActivity.this,CravateClassique.class);
                                startActivity(i);
                            } else if (id == 1) {
                                Intent iiii = new Intent(MainActivity.this,CravateSlim.class);
                                startActivity(iiii);
                            } else if (id == 2) {
                                Intent ii = new Intent(MainActivity.this, CravateLarge.class);
                                startActivity(ii);
                            } else if (id == 3) {
                                    Intent iii = new Intent(MainActivity.this,CravateSoie.class);
                                    startActivity(iii);
                            } else if (id == 4) {
                            ...
                            if (id == 0) {
                                Intent i2 = new Intent(MainActivity.this,CeintureCuir.class);
                                startActivity(i2);

                            } else if (id==1) {
                                Intent i2222 = new Intent(MainActivity.this,CeintureDjean.class);
                                startActivity(i2222);
                            }
                            ...
                            if (id == 0) {
                                Intent i22 = new Intent(MainActivity.this,Debardeur.class);
                                startActivity(i22);

                            } else if (id==1) {
                                Intent i21 = new Intent(MainActivity.this,Chaussettes.class);
                                startActivity(i21);
                            }
                            else if (id==2) {
                                Intent i22 = new Intent(MainActivity.this,Boxer.class);
                                startActivity(i22);
                            }
                            ...
                            if (id == 0) {
                                Intent i3 = new Intent(MainActivity.this,Pochette.class);
                                startActivity(i3);
                            } else if (id == 1) {
                                Intent i33 = new Intent(MainActivity.this,PorteCartes.class);
                                startActivity(i33);
                            } else if (id == 2) {
                                Intent i333 = new Intent(MainActivity.this,PorteMonnaie.class);
                                startActivity(i333);

                            } else if (id == 3) {
                                Intent i3333 = new Intent(MainActivity.this,CoffertCadeau.class);
                                startActivity(i3333);
                            ...
                            if (id == 0) {
                                Intent i55 = new Intent(MainActivity.this,CravateEnfant.class);
                                startActivity(i55);
                            } else if (id == 1) {
                                Intent i66 = new Intent(MainActivity.this,CravateEnfant.class);
                                startActivity(i66);
                            }
                        }
                        else if (groupPosition==7 ){
                            if (id == 0) {
                                Intent i5 = new Intent(MainActivity.this,BlogHistoireCravate.class);
                                startActivity(i5);
                            } else if (id == 1) {
                                Intent i6 = new Intent(MainActivity.this,BlogNosConseils.class);
                                startActivity(i6);
                            } else if (id == 2) {
                                Common.showToast(context, "Comment Faire un Noeud de Cravate");
                            } else if (id == 3) {
                                Intent i7 = new Intent(MainActivity.this,BlogChoisirTailleCeinture.class);
                                startActivity(i7);
                            }else{
                                Intent i8 = new Intent(MainActivity.this,BlogReglerCeinture.class);
                                startActivity(i8);
        ...
        posts = new ArrayList<>();
        posts.add(new post(R.drawable.fatouch));
        posts.add(new post(R.drawable.costum));
        posts.add(new post(R.drawable.ceinture));
        posts.add(new post(R.drawable.acess));
