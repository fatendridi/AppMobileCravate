...
public  class ProduitAdapterCravateSoie extends RecyclerView.Adapter <MyViewHolderCravateSoie> {
    ArrayList<ProduitCravateSoie> dataset;
    Activity act ;

    public ProduitAdapterCravateSoie(ArrayList<ProduitCravateSoie> DataModels, Activity act) {
    ...
    @Override
    public MyViewHolderCravateSoie onCreateViewHolder(ViewGroup parent, int viewType ) {
        View view= LayoutInflater.from( act ).inflate( R.layout.item_posts_cravate_soie , parent,false );
        return new MyViewHolderCravateSoie( view);
    }

    @Override
    public void onBindViewHolder(MyViewHolderCravateSoie holder, int position) {
