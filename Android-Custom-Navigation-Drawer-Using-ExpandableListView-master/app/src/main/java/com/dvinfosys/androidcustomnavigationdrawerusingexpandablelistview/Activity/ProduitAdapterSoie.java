...
public  class ProduitAdapterSoie extends RecyclerView.Adapter <MyViewHolderCravateSoie> {
    ArrayList<ProduitCravateSoie> dataset;
    Activity act ;

    public ProduitAdapterSoie(ArrayList<ProduitCravateSoie> DataModels, Activity act) {
