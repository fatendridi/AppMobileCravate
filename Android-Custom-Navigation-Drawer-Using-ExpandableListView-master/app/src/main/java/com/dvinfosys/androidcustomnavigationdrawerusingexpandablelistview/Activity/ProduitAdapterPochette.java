...
public  class ProduitAdapterPochette extends RecyclerView.Adapter <MyViewHolderPochette> {
    ArrayList<ProduitPochette> dataset;
    Activity act ;

    public ProduitAdapterPochette(ArrayList<ProduitPochette> DataModels, Activity act) {
    ...
    @Override
    public MyViewHolderPochette onCreateViewHolder(ViewGroup parent, int viewType ) {
        View view= LayoutInflater.from( act ).inflate( R.layout.item_posts_pochette , parent,false );
        return new MyViewHolderPochette( view);
    }

    @Override
    public void onBindViewHolder(MyViewHolderPochette holder, int position) {
