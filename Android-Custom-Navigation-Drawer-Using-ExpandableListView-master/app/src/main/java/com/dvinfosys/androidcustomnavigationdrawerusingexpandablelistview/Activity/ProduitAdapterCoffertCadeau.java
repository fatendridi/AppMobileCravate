...
public  class ProduitAdapterCoffertCadeau extends RecyclerView.Adapter <MyViewHolderCoffertCadeau> {
    ArrayList<ProduitCoffertCadeau> dataset;
    Activity act ;

    public ProduitAdapterCoffertCadeau(ArrayList<ProduitCoffertCadeau> DataModels, Activity act) {
    ...
    @Override
    public MyViewHolderCoffertCadeau onCreateViewHolder(ViewGroup parent, int viewType ) {
        View view= LayoutInflater.from( act ).inflate( R.layout.item_posts_coffert , parent,false );
        return new MyViewHolderCoffertCadeau( view);
    }



    @Override
    public void onBindViewHolder(MyViewHolderCoffertCadeau holder, int position) {
