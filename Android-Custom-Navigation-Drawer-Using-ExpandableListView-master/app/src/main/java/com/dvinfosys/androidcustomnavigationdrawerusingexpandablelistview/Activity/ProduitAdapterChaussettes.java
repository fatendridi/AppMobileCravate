...
public  class ProduitAdapterChaussettes extends RecyclerView.Adapter <MyViewHolderChaussettes> {
    ArrayList<ProduitChaussettes> dataset;
    Activity act ;

    public ProduitAdapterChaussettes(ArrayList<ProduitChaussettes> DataModels, Activity act) {
    ...
    @Override
    public MyViewHolderChaussettes onCreateViewHolder(ViewGroup parent, int viewType ) {
        View view= LayoutInflater.from( act ).inflate( R.layout.item_posts_chaussettes , parent,false );
        return new MyViewHolderChaussettes( view);
    }



    @Override
    public void onBindViewHolder(MyViewHolderChaussettes holder, int position) {
