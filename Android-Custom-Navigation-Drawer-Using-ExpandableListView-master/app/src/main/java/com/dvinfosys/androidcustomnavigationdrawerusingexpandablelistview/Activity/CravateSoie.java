...
public class CravateSoie extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener{

    private static final String URL_DATA1 = "https://www.cravate.tn/api/products/?output_format=JSON&filter[id_category_default]=49&display=[id,name,price]&ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V&fbclid=IwAR23UWKRg7E_vqwdIhUTyzxksVgGS3mExqGC1uBnTmchmQditpvOz9AioDU";
    private static final String URL_DATA = "https://www.cravate.tn/api/images/products&filter[id_category_default]=49?ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V";
    private static final String WS_KEY = "?ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V";

    ArrayList<ProduitCravateSoie> listprod;
  ...
  Button btn_essayage ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cravate_soie);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_back:
                        Intent c = new Intent(CravateSoie.this, MainActivity.class);
                        startActivity(c);
                        break;
                    case R.id.navigation_usb:
                        Intent a = new Intent(CravateSoie.this, Panier.class);
                        startActivity(a);
                        break;
                    case R.id.navigation_logo:
                        Intent b = new Intent(CravateSoie.this, Compte.class);
                        startActivity(b);
                        break;
                ...
                .addOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
                    ...
                    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                        ...
                        if (id == 0) {
                            ...
                            Intent it = new Intent(CravateSoie.this,Chemise.class);
                            startActivity(it);
                            ...
                            Intent i1 = new Intent(CravateSoie.this,NoeudPapillon.class);
                            startActivity(i1);
                ...
                .addOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                    ...
                    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                        ...
                        if(groupPosition==0) {
                            ...
                            if (id == 0) {
                                Intent i = new Intent(CravateSoie.this,CravateClassique.class);
                                startActivity(i);
                            } else if (id == 1) {
                                Intent iiii = new Intent(CravateSoie.this,CravateSlim.class);
                                startActivity(iiii);
                            } else if (id == 2) {
                                Intent ii = new Intent(CravateSoie.this, CravateLarge.class);
                                startActivity(ii);
                            } else if (id == 3) {
                                Intent iii = new Intent(CravateSoie.this,CravateSoie.class);
                                startActivity(iii);
                            } else if (id == 4) {
                            ...
                            if (id == 0) {
                                Intent i2 = new Intent(CravateSoie.this,CeintureCuir.class);
                                startActivity(i2);
                            ...
                            if (id == 0) {
                                Intent i22 = new Intent(CravateSoie.this,Debardeur.class);
                                startActivity(i22);

                            } else if (id==1) {
                                Intent i21 = new Intent(CravateSoie.this,Chaussettes.class);
                                startActivity(i21);
                            }
                            else if (id==2) {
                            ...
                            if (id == 0) {
                                Intent i3 = new Intent(CravateSoie.this,Pochette.class);
                                startActivity(i3);
                            } else if (id == 1) {
                                Intent i33 = new Intent(CravateSoie.this,PorteCartes.class);
                                startActivity(i33);
                            } else if (id == 2) {
                                Intent i333 = new Intent(CravateSoie.this,PorteMonnaie.class);
                                startActivity(i333);

                            } else if (id == 3) {
                                Intent i3333 = new Intent(CravateSoie.this,CoffertCadeau.class);
                                startActivity(i3333);
                            ...
                            if (id == 0) {
                                Intent i5 = new Intent(CravateSoie.this,BlogHistoireCravate.class);
                                startActivity(i5);
                            } else if (id == 1) {
                                Intent i6 = new Intent(CravateSoie.this,BlogNosConseils.class);
                                startActivity(i6);
                            } else if (id == 2) {
                                Common.showToast(context, "Comment Faire un Noeud de Cravate");
                            } else if (id == 3) {
                                Intent i7 = new Intent(CravateSoie.this,BlogChoisirTailleCeinture.class);
                                startActivity(i7);
                            }else{
                                Intent i8 = new Intent(CravateSoie.this,BlogReglerCeinture.class);
                                startActivity(i8);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CravateSoie.this));
        listprod=new ArrayList<ProduitCravateSoie>();
        ...
        StringRequest stringRequest3 = new StringRequest(StringRequest.Method.GET, URL_DATA1, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i =0;i<array.length();i++){
                        ...
                        produit = new ProduitCravateSoie(object.getInt("id"),object.getString("name"),object.getString("price").substring(0,6)+" Dt");
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(CravateSoie.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
        stringRequest3.setRetryPolicy(retryPolicy);

        RequestQueue requestQueue = Volley.newRequestQueue(CravateSoie.this);
        ...
        StringRequest stringRequest=new StringRequest(StringRequest.Method.GET, URL_DATA, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    final ArrayList<ProduitCravateSoie> produits = new ArrayList<>();
                    ...
                    for(int i=0; i<image.length(); i++){
                        for (final ProduitCravateSoie prd : listprod){
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        try {
                                            ...
                                            if(image instanceof JSONArray){
                                                ...
                                                ProduitCravateSoie prod = new ProduitCravateSoie(prd.getId(), prd.getName(),prd.getPrice(), imagesarray.getJSONObject(0).getString("xlink:href")+WS_KEY);
                                                produits.add(prod);
                                                ...
                                                ProduitCravateSoie prod = new ProduitCravateSoie(prd.getId(), prd.getName(), prd.getPrice(),imageobj.getString("xlink:href")+WS_KEY);
                                                produits.add(prod);
                                            }
                                        ...
                                        adapter=new ProduitAdapterCravateSoie(produits,CravateSoie.this);
        ...
        RequestQueue requestQueue2 = Volley.newRequestQueue(CravateSoie.this);
