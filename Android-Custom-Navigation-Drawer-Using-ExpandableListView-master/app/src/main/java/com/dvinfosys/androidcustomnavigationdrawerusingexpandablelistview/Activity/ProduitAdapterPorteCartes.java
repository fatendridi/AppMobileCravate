...
public  class ProduitAdapterPorteCartes extends RecyclerView.Adapter <MyViewHolderPorteCartes> {
    ArrayList<ProduitPorteCartes> dataset;
    Activity act ;

    public ProduitAdapterPorteCartes(ArrayList<ProduitPorteCartes> DataModels, Activity act) {
    ...
    @Override
    public MyViewHolderPorteCartes onCreateViewHolder(ViewGroup parent, int viewType ) {
        View view= LayoutInflater.from( act ).inflate( R.layout.item_posts_porte_cartes , parent,false );
        return new MyViewHolderPorteCartes( view);
    }



    @Override
    public void onBindViewHolder(MyViewHolderPorteCartes holder, int position) {
