...
public  class ProduitAdapterCeintureDjean extends RecyclerView.Adapter <MyViewHolderCeintureDjean> {
    ArrayList<ProduitCeintureDjean> dataset;
    Activity act ;

    public ProduitAdapterCeintureDjean(ArrayList<ProduitCeintureDjean> DataModels, Activity act) {
    ...
    @Override
    public MyViewHolderCeintureDjean onCreateViewHolder(ViewGroup parent, int viewType ) {
        View view= LayoutInflater.from( act ).inflate( R.layout.item_posts_ceinture_djean, parent,false );
        return new MyViewHolderCeintureDjean( view);
    }



    @Override
    public void onBindViewHolder(MyViewHolderCeintureDjean holder, int position) {
