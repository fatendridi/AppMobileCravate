...
import com.dvinfosys.androidcustomnavigationdrawerusingexpandablelistview.Activity.CompteCravateConnexion2;
...
public class Compte extends AppCompatActivity
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_back:
                        Intent b = new Intent(Compte.this,MainActivity.class);
                        startActivity(b);
                        break;
                    case R.id.navigation_usb:
                        Intent a = new Intent(Compte.this,Panier.class);
                        startActivity(a);
                        break;
    ...
    {
        Intent intent = new Intent(this, CompteCravateConnexion2.class);
