...
public class PorteCartes extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener{
    private static final String URL_DATA1 = "https://www.cravate.tn/api/products/?output_format=JSON&filter[id_category_default]=50&display=[id,name,price]&ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V&fbclid=IwAR23UWKRg7E_vqwdIhUTyzxksVgGS3mExqGC1uBnTmchmQditpvOz9AioDU";
    private static final String URL_DATA = "https://www.cravate.tn/api/images/products&filter[id_category_default]=50?ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V";
    private static final String WS_KEY = "?ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V";

    ArrayList<ProduitPorteCartes> listprod;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_porte_cartes);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_back:
                        Intent c = new Intent(PorteCartes.this,MainActivity.class);
                        startActivity(c);
                        break;
                    case R.id.navigation_usb:
                        Intent a = new Intent(PorteCartes.this,Panier.class);
                        startActivity(a);
                        break;
                    case R.id.navigation_logo:
                        Intent b = new Intent(PorteCartes.this,Compte.class);
                        startActivity(b);
                        break;
                ...
                .addOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
                    ...
                    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                        ...
                        if (id == 0) {
                            ...
                            Intent it = new Intent(PorteCartes.this,Chemise.class);
                            startActivity(it);
                            ...
                            Intent i1 = new Intent(PorteCartes.this,NoeudPapillon.class);
                            startActivity(i1);
                ...
                .addOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                    ...
                    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                        ...
                        if(groupPosition==0) {
                            ...
                            if (id == 0) {
                                Intent i = new Intent(PorteCartes.this,CravateClassique.class);
                                startActivity(i);
                            } else if (id == 1) {
                                Intent iiii = new Intent(PorteCartes.this,CravateSlim.class);
                                startActivity(iiii);
                            } else if (id == 2) {
                                Intent ii = new Intent(PorteCartes.this, CravateLarge.class);
                                startActivity(ii);
                            } else if (id == 3) {
                                Intent iii = new Intent(PorteCartes.this,CravateSoie.class);
                                startActivity(iii);
                            } else if (id == 4) {
                            ...
                            if (id == 0) {
                                Intent i2 = new Intent(PorteCartes.this,CeintureCuir.class);
                                startActivity(i2);
                            ...
                            if (id == 0) {
                                Intent i22 = new Intent(PorteCartes.this,Debardeur.class);
                                startActivity(i22);

                            } else if (id==1) {
                                Intent i21 = new Intent(PorteCartes.this,Chaussettes.class);
                                startActivity(i21);
                            }
                            else if (id==2) {
                            ...
                            if (id == 0) {
                                Intent i3 = new Intent(PorteCartes.this,Pochette.class);
                                startActivity(i3);
                            } else if (id == 1) {
                                Intent i33 = new Intent(PorteCartes.this,PorteCartes.class);
                                startActivity(i33);
                            } else if (id == 2) {
                                Intent i333 = new Intent(PorteCartes.this,PorteMonnaie.class);
                                startActivity(i333);

                            } else if (id == 3) {
                                Intent i3333 = new Intent(PorteCartes.this,CoffertCadeau.class);
                                startActivity(i3333);
                            ...
                            if (id == 0) {
                                Intent i5 = new Intent(PorteCartes.this,BlogHistoireCravate.class);
                                startActivity(i5);
                            } else if (id == 1) {
                                Intent i6 = new Intent(PorteCartes.this,BlogNosConseils.class);
                                startActivity(i6);
                            } else if (id == 2) {
                                Common.showToast(context, "Comment Faire un Noeud de Cravate");
                            } else if (id == 3) {
                                Intent i7 = new Intent(PorteCartes.this,BlogChoisirTailleCeinture.class);
                                startActivity(i7);
                            }else{
                                Intent i8 = new Intent(PorteCartes.this,BlogReglerCeinture.class);
                                startActivity(i8);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(PorteCartes.this));
        listprod=new ArrayList<ProduitPorteCartes>();
        ...
        StringRequest stringRequest3 = new StringRequest(StringRequest.Method.GET, URL_DATA1, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i =0;i<array.length();i++){
                        ...
                        produit = new ProduitPorteCartes(object.getInt("id"),object.getString("name"),object.getString("price").substring(0,6)+" Dt");
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PorteCartes.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
        stringRequest3.setRetryPolicy(retryPolicy);

        RequestQueue requestQueue = Volley.newRequestQueue(PorteCartes.this);
        ...
        StringRequest stringRequest=new StringRequest(StringRequest.Method.GET, URL_DATA, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    final ArrayList<ProduitPorteCartes> produits = new ArrayList<>();
                    ...
                    for(int i=0; i<image.length(); i++){
                        for (final ProduitPorteCartes prd : listprod){
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        try {
                                            ...
                                            if(image instanceof JSONArray){
                                                ...
                                                ProduitPorteCartes prod = new ProduitPorteCartes(prd.getId(), prd.getName(),prd.getPrice(), imagesarray.getJSONObject(0).getString("xlink:href")+WS_KEY);
                                                produits.add(prod);
                                                ...
                                                ProduitPorteCartes prod = new ProduitPorteCartes(prd.getId(), prd.getName(), prd.getPrice(),imageobj.getString("xlink:href")+WS_KEY);
                                                produits.add(prod);
                                            }
                                        ...
                                        adapter=new ProduitAdapterPorteCartes(produits,PorteCartes.this);
        ...
        RequestQueue requestQueue2 = Volley.newRequestQueue(PorteCartes.this);
