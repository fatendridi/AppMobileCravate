...
public class Chemise extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener{
    private static final String URL_DATA1 = "https://www.cravate.tn/api/products/?output_format=JSON&filter[id_category_default]=24&display=[id,name,price]&ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V&fbclid=IwAR23UWKRg7E_vqwdIhUTyzxksVgGS3mExqGC1uBnTmchmQditpvOz9AioDU";
    private static final String URL_DATA = "https://www.cravate.tn/api/images/products&filter[id_category_default]=24?ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V";
    private static final String WS_KEY = "?ws_key=BZ919DXR2Z7PEZPY76J4MVDJWLP5MJ6V";

    ArrayList<ProduitChemise> listprod;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_back:
                        Intent c = new Intent(Chemise.this,MainActivity.class);
                        startActivity(c);
                        break;
                    case R.id.navigation_usb:
                        Intent a = new Intent(Chemise.this,Panier.class);
                        startActivity(a);
                        break;
                    case R.id.navigation_logo:
                        Intent b = new Intent(Chemise.this,Compte.class);
                        startActivity(b);
                        break;
                ...
                .addOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
                    ...
                    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                        ...
                        if (id == 0) {
                            ...
                            Intent it = new Intent(Chemise.this,Chemise.class);
                            startActivity(it);
                            ...
                            Intent i1 = new Intent(Chemise.this,NoeudPapillon.class);
                            startActivity(i1);
                ...
                .addOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                    ...
                    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                        ...
                        if(groupPosition==0) {
                            ...
                            if (id == 0) {
                                Intent i = new Intent(Chemise.this,CravateClassique.class);
                                startActivity(i);
                            } else if (id == 1) {
                                Intent iiii = new Intent(Chemise.this,CravateSlim.class);
                                startActivity(iiii);
                            } else if (id == 2) {
                                Intent ii = new Intent(Chemise.this, CravateLarge.class);
                                startActivity(ii);
                            } else if (id == 3) {
                                Intent iii = new Intent(Chemise.this,CravateSoie.class);
                                startActivity(iii);
                            } else if (id == 4) {
                            ...
                            if (id == 0) {
                                Intent i2 = new Intent(Chemise.this,CeintureCuir.class);
                                startActivity(i2);
                            ...
                            if (id == 0) {
                                Intent i22 = new Intent(Chemise.this,Debardeur.class);
                                startActivity(i22);

                            } else if (id==1) {
                                Intent i21 = new Intent(Chemise.this,Chaussettes.class);
                                startActivity(i21);
                            }
                            else if (id==2) {
                            ...
                            if (id == 0) {
                                Intent i3 = new Intent(Chemise.this,Pochette.class);
                                startActivity(i3);
                            } else if (id == 1) {
                                Intent i33 = new Intent(Chemise.this,PorteCartes.class);
                                startActivity(i33);
                            } else if (id == 2) {
                                Intent i333 = new Intent(Chemise.this,PorteMonnaie.class);
                                startActivity(i333);

                            } else if (id == 3) {
                                Intent i3333 = new Intent(Chemise.this,CoffertCadeau.class);
                                startActivity(i3333);
                            ...
                            if (id == 0) {
                                Intent i5 = new Intent(Chemise.this,BlogHistoireCravate.class);
                                startActivity(i5);
                            } else if (id == 1) {
                                Intent i6 = new Intent(Chemise.this,BlogNosConseils.class);
                                startActivity(i6);
                            } else if (id == 2) {
                                Common.showToast(context, "Comment Faire un Noeud de Cravate");
                            } else if (id == 3) {
                                Intent i7 = new Intent(Chemise.this,BlogChoisirTailleCeinture.class);
                                startActivity(i7);
                            }else{
                                Intent i8 = new Intent(Chemise.this,BlogReglerCeinture.class);
                                startActivity(i8);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Chemise.this));
        listprod=new ArrayList<ProduitChemise>();
        ...
        StringRequest stringRequest3 = new StringRequest(StringRequest.Method.GET, URL_DATA1, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i =0;i<array.length();i++){
                        ...
                        produit = new ProduitChemise(object.getInt("id"),object.getString("name"),object.getString("price").substring(0,6)+" Dt");
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Chemise.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
        stringRequest3.setRetryPolicy(retryPolicy);

        RequestQueue requestQueue = Volley.newRequestQueue(Chemise.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0; i<image.length(); i++){
                        for (final ProduitChemise prd : listprod){
                            if(String.valueOf(prd.getId()).equals(image.getJSONObject(i).getString("id").toString())){
                                ...
                                StringRequest stringRequest2 =new StringRequest(StringRequest.Method.GET, urlalbum+WS_KEY, new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        adapter=new ProduitAdapterChemise(produits,Chemise.this);
        ...
        RequestQueue requestQueue2 = Volley.newRequestQueue(Chemise.this);
